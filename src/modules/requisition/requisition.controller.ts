...
export const createRequisition = async (
  ...
  try {
    logger.info("=== CREATE REQUISITION CONTROLLER ===");
    logger.info("Request body:", JSON.stringify(req.body, null, 2));
    logger.info("Content-Type:", req.headers["content-type"]);
    logger.info("User context:", req.context);
    ...
    logger.error("createRequisition controller error:", error);
    next(error);
  }
};
...
export const updateRequisition = async (
  ...
  try {
    logger.info("updateRequisition controller - params:", req.params);
    logger.info(
      "updateRequisition controller - body keys:",
      Object.keys(req.body),
    );
    logger.info("updateRequisition controller - body:", req.body);
    ...
    const attachmentFiles = req.files as Express.Multer.File[];
    logger.info(
      "updateRequisition controller - files:",
    ...
    logger.error("updateRequisition controller error:", error);
    next(error);
  }
};
